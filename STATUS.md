...
line (0x0045C000) patched**. Measured: **1,186 of 1,239** entries in
`docs/functions.tsv` below that address have a patch inside them -- so 53
outstanding, which is 1,239 minus 1,186 -- from 1,355 patched addresses. That figure counts merged entries generously and is a
...
53 entries outstanding start at **480 bytes**, and the median is over 1,000.
