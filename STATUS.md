...
**UPDATE (2026-09-15): 176 symbols placed, 62.1% of meaningful bytes.** Later
...
sweep to **1,368 strings, 32,098 bytes zeroed**.
...
`mkglobals.py` and `placement.py`. **1,368 strings, 32,098 bytes zeroed** -- log,
