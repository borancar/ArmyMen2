...
| | | how |
|---|---:|---|
| `patch_replace` sites | 400 | `grep -rho patch_replace src/game \| wc -l` |
| distinct addresses reconstructed | 400 | 393 of them below the CRT line |
| sub-CRT functions in the image | 1,239 | `docs/functions.tsv` |
| sub-CRT code reconstructed | 91,728 / 372,816 B (**24.6%**) | patched entries' sizes over the total |
...
- **14 functions are left in the event.cpp band, and most are tiny.** Four
