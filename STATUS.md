...
**UPDATE (2026-09-15): 169 symbols placed, 62.0% of meaningful bytes.** Later
...
sweep to **1,362 strings, 32,047 bytes zeroed**.
...
`mkglobals.py` and `placement.py`. **1,362 strings, 32,047 bytes zeroed** -- log,
