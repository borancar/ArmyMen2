...
Last updated: **2026-08-21**, at `835dc7e`. Working tree clean.
...
| | | how |
|---|---:|---|
| `patch_replace` sites | 306 | `grep -rc patch_replace src/game` |
| distinct addresses reconstructed | 306 | 299 of them below the CRT line |
...
| pure unreconstructed leaves | 7 | `tools/vectors.py --all` |
...
| `make selftest` | current | **7,057** vectors, 15,228 words, 13,956 lines, 9,062 spine, 198 variable -- 0 fail |
...
2. Keep taking pure leaves: 4 real ones left -- `0x00439cc0`, `0x0041ade0`,
   `0x00423ee0` and one more, all 160B or larger.
