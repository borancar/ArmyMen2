...
check:
	@rc=0; \
	for t in coverage comcalls merges checkcom checkhooks binpatches blindspots checkclaims crt scripttokens scriptactions checkpatches checkseams checkglobals checksplit; do \
	    printf '  %-12s ' "$$t"; \
