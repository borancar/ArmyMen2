...
static const struct {
    ...
    { ADDR_DRAW_MENU_CURSOR, "DrawMenuCursor",
      { 0xA1, 0xF8, 0xCE, 0x4F, 0x00, 0x83, 0xEC, 0x20 }, 8 },
    ...
    { ADDR_SCROLL_MAP_CACHE, "ScrollMapCache",
      { 0x83, 0xEC, 0x50, 0xA1, 0x94, 0x4E, 0x51, 0x00 }, 8 },
    { ADDR_MERGE_DIRTY, "ScrollView",
      { 0x83, 0xEC, 0x40, 0x8D, 0x44, 0x24, 0x10, 0x56 }, 8 },
    { ADDR_COMPOSE_FRAME, "ComposeFrame",
      { 0x83, 0xEC, 0x20, 0xE8, 0xE8, 0xD9, 0xFF, 0xFF }, 8 },
    { ADDR_SET_DRAW_TARGET, "SetDrawTarget",
      { 0x8B, 0x44, 0x24, 0x04, 0x8B, 0x0D, 0x28, 0x71 }, 8 },
    { ADDR_RESTORE_TILESET, "RestoreTileSet",
      { 0x81, 0xEC, 0xAC, 0x06, 0x00, 0x00, 0x53, 0x55 }, 8 },
    { ADDR_SET_GAME_PALETTE, "SetGamePalette",
      { 0x55, 0x8B, 0xEC, 0x83, 0xE4, 0xF8, 0x83, 0xEC }, 8 },
    ...
    { ADDR_POLL_MOUSE, "PollMouse",
      { 0x83, 0xEC, 0x14, 0xA1, 0xD4, 0x2F, 0x51, 0x00 }, 8 },
    { ADDR_POLL_KEYBOARD, "PollKeyboard",
      { 0x8B, 0x0D, 0xD8, 0x2F, 0x51, 0x00, 0x85, 0xC9 }, 8 },
    ...
    { ADDR_SET_STREAM_VOLUME, "SetStreamVolume",
      { 0xA1, 0x68, 0xA4, 0x4F, 0x00, 0x85, 0xC0, 0x74 }, 8 },
    { ADDR_OPEN_AUDIO_STREAM, "OpenAudioStream",
      { 0x8B, 0x44, 0x24, 0x04, 0x83, 0xEC, 0x28, 0x56 }, 8 },
    { ADDR_RELEASE_SOUND_BUFS, "ReleaseSoundObjects",
    ...
    { ADDR_HOST_BATTLE, "HostBattle",
      { 0x53, 0x8B, 0x1D, 0x58, 0xA0, 0x65, 0x00, 0x55 }, 8 },
    ...
    { ADDR_START_PACKET_THREAD, "StartPacketThread",
      { 0x68, 0xE8, 0xD8, 0x48, 0x00, 0xE8, 0x56, 0xEE }, 8 },
    { ADDR_MSG_LIST_INIT, "MsgListInit",
      { 0x56, 0x8B, 0x74, 0x24, 0x08, 0x6A, 0x00, 0x6A }, 8 },
    { ADDR_EVENT_CLOSE, "EventClose",
      { 0x56, 0x8B, 0x74, 0x24, 0x08, 0x8B, 0x06, 0xC7 }, 8 },
    { ADDR_COMM_ENUM_PLAYERS, "CommEnumPlayers",
      { 0xA1, 0xB0, 0x51, 0x47, 0x00, 0x33, 0xC9, 0x39 }, 8 },
