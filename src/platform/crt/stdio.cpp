...
/* The _iob FILE array at 0x0048CEC0 (20 CRT_FILE slots, 640 bytes; only stdin/
 * stdout/stderr are initialised, their _ptr/_base into the placed origbss I/O
 * buffers). Runtime-written stdio state, migrated non-const, byte-checked at
 * init; the raw buffer pointers resolve because origbss is placed. */
extern "C" uint8_t am2_crt_iob[640] = {
    0x00, 0x4B, 0x66, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x4B, 0x66, 0x00, 0x01, 0x01, 0x00, 0x00,
